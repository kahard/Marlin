...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  28.61,  28.61 }
    #define DEFAULT_Ki_LIST {   3.19,   3.19 }
    #define DEFAULT_Kd_LIST {  64.09,  64.09 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 116.00
  #define DEFAULT_bedKi 19.86
  #define DEFAULT_bedKd 451.62
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.8, 20, 0 }
